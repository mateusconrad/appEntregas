...
import 'ComecarEntrega.dart';

class RemessasPendentesPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Remessas Pendentes'),
      ),
            ...
            itemBuilder: (context, index) {
              return Card(
                child: ListTile(
                  ...
                  onTap: () {
                    // Navegar para a página de detalhes da remessa
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => DetalhesRemessaPage(remessaId: remessas[index].id),
                      ),
                    );
                  },
                ),
